...
int main()
{
  ...
  PRM_Benchmark pm = mapa.GoalBiasRRT_Centralized(500,0.5,0.05,0.25,true,false, 2); //(int n,double r,double p,double epsilon, bool outputPath, bool outPutTree, int numOfRobs)
  // PRM_Benchmark pm;
  //
  // int from = 1;
  // int to = 6;
