...
%     plot(PRM(j,3), PRM(j,4), '-o', 'MarkerEdgeColor', [0.125, 0.325, 0.875])
    plot([PRM(j,1) PRM(j,3)], [PRM(j,2) PRM(j,4)], '-o', 'MarkerEdgeColor', ...
            [0.125, 0.325, 0.875], 'Color',[0.125, 0.325, 0.875],...
            'MarkerSize', 2.5)
end
